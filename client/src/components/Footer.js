...
const Footer = () => {
  return (
    <footer className="text-main-yellow bg-main-dark body-font">
      <div className="container px-2 py-6 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
