  ...
  return (
    <>
      <body className="bg-main-yellow full-class">
        ...
        <div className="mt-10 bg-pale-dark sm:mt-0">
              ...
              <form action="#" method="POST">
                <div className="overflow-hidden shadow sm:rounded-md">
                  ...
                  <div className="bg-gray-50 px-4 py-3 text-right sm:px-6">
                    <button
                      type="submit"
                      className="inline-flex justify-center rounded-md bg-main-dark py-2 px-3 text-sm font-semibold text-main-yellow shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
                    >
                      Save
                    </button>
                  </div>
